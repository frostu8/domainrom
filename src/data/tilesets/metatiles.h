...
const u16 gMetatiles_TrollTower[] = INCBIN_U16("data/tilesets/secondary/troll_tower/metatiles.bin");
const u32 gMetatileAttributes_TrollTower[] = INCBIN_U32("data/tilesets/secondary/troll_tower/metatile_attributes.bin");
