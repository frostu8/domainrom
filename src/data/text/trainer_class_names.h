const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_RS_AROMA_LADY]       = _("Murderer"),
    [TRAINER_CLASS_RS_RUIN_MANIAC]      = _("Jelqer"),
    [TRAINER_CLASS_INTERVIEWER]         = _("Troller"),
    [TRAINER_CLASS_RS_TUBER_F]          = _("YouTuber"),
    [TRAINER_CLASS_RS_TUBER_M]          = _("Animator"),
    [TRAINER_CLASS_RS_COOLTRAINER]      = _("Dunderhead"),
    [TRAINER_CLASS_HEX_MANIAC]          = _("Drunkard"),
    [TRAINER_CLASS_RS_LADY]             = _("FGC Member"),
    [TRAINER_CLASS_RS_BEAUTY]           = _("Murderer"),
    [TRAINER_CLASS_RICH_BOY]            = _("RICH BOY"),
    [TRAINER_CLASS_RS_POKEMANIAC]       = _("Liberal"),
    [TRAINER_CLASS_RS_SWIMMER_M]        = _("Plug"),
    [TRAINER_CLASS_RS_BLACK_BELT]       = _("Molded"),
    [TRAINER_CLASS_GUITARIST]           = _("GUITARIST"),
    [TRAINER_CLASS_KINDLER]             = _("KINDLER"),
    [TRAINER_CLASS_RS_CAMPER]           = _("Jock"),
    [TRAINER_CLASS_BUG_MANIAC]          = _("BUG MANIAC"),
    [TRAINER_CLASS_RS_PSYCHIC]          = _("Waifu"),
    [TRAINER_CLASS_RS_GENTLEMAN]        = _("Weeaboo"),
    ...
    [TRAINER_CLASS_RS_YOUNGSTER]        = _("Super  Senior"),
    [TRAINER_CLASS_RS_CHAMPION]         = _("CHAMPION"),
    [TRAINER_CLASS_RS_FISHERMAN]        = _("Employee"),
    [TRAINER_CLASS_TRIATHLETE]          = _("TRIATHLETE"),
    [TRAINER_CLASS_DRAGON_TAMER]        = _("DRAGON TAMER"),
    [TRAINER_CLASS_RS_BIRD_KEEPER]      = _("Water Bender"),
    [TRAINER_CLASS_NINJA_BOY]           = _("NINJA BOY"),
    [TRAINER_CLASS_BATTLE_GIRL]         = _("BATTLE GIRL"),
    [TRAINER_CLASS_PARASOL_LADY]        = _("PARASOL LADY"),
    [TRAINER_CLASS_RS_SWIMMER_F]        = _("Game Developer"),
    [TRAINER_CLASS_RS_PICNICKER]        = _("Twink"),
    [TRAINER_CLASS_RS_TWINS]            = _("Cop"),
    [TRAINER_CLASS_RS_SAILOR]           = _("Demon"),
    ...
    [TRAINER_CLASS_RS_LASS]             = _("Furnature"),
    [TRAINER_CLASS_RS_BUG_CATCHER]      = _("Robot"),
    [TRAINER_CLASS_RS_HIKER]            = _("Uncle"),
    ...
    [TRAINER_CLASS_AQUA_ADMIN]          = _("Oons Admin"),
    ...
    [TRAINER_CLASS_BOSS]                = _("Oons Boss"),
    [TRAINER_CLASS_LEADER]              = _("Leader"),
    [TRAINER_CLASS_TEAM_ROCKET]         = _("Oons Goon"),
