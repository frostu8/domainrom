...
TOOLDIRS := $(filter-out tools/poryscript tools/agbcc tools/binutils tools/analyze_source,$(wildcard tools/*))
...
data/%.inc: data/%.pory; $(SCRIPT) -i $< -o $@ -lm=false -fc tools/poryscript/font_config.json
